...
def build_azure_bare_metal_instances_start_request(
    resource_group_name: str, azure_bare_metal_instance_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2023-07-31-preview"))
...
def build_azure_bare_metal_instances_restart_request(
...
def build_azure_bare_metal_instances_shutdown_request(
    resource_group_name: str, azure_bare_metal_instance_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_azure_bare_metal_instances_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_azure_bare_metal_instances_list_by_resource_group_request(
...
def build_azure_bare_metal_instances_get_request(
    resource_group_name: str, azure_bare_metal_instance_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_azure_bare_metal_instances_update_request(
    resource_group_name: str, azure_bare_metal_instance_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_azure_bare_metal_storage_instances_list_by_subscription_request(
...
def build_azure_bare_metal_storage_instances_list_by_resource_group_request(
    resource_group_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_azure_bare_metal_storage_instances_get_request(
...
def build_azure_bare_metal_storage_instances_create_request(
    resource_group_name: str, azure_bare_metal_storage_instance_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_azure_bare_metal_storage_instances_update_request(
    resource_group_name: str, azure_bare_metal_storage_instance_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_azure_bare_metal_storage_instances_delete_request(
    resource_group_name: str, azure_bare_metal_storage_instance_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class AzureBareMetalInstancesOperations:
    ...
    def begin_restart(
        ...
        **kwargs: Any
        ...
        :param azure_bare_metal_instance_name: Name of the Azure Bare Metal Instance, also known as the
         ResourceName. Required.
        :type azure_bare_metal_instance_name: str
        :keyword force: When set to 'true', this parameter empowers the server with the ability to
         forcefully terminate and halt any existing processes that may be running on the server. Default
         value is None.
    ...
    def _shutdown_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, azure_bare_metal_instance_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_shutdown(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._shutdown_initial(  # type: ignore
                resource_group_name=resource_group_name,
                azure_bare_metal_instance_name=azure_bare_metal_instance_name,
                cls=lambda x, y, z: x,
                headers=_headers,
    ...
    def list(self, **kwargs: Any) -> Iterable[JSON]:
        ...
        Example:
            .. code-block:: python
                ...
                response == {
                    "display": {
                        "description": "str",  # Optional. The localized friendly description
                          for the operation as shown to the user.
                        "operation": "str",  # Optional. The localized friendly name for the
                          operation as shown to the user.
                        "provider": "str",  # Optional. The localized friendly form of the
                          resource provider name.
                        "resource": "str"  # Optional. The localized friendly form of the
                          resource type related to this action/operation.
                    },
                    "isDataAction": bool,  # Optional. indicates whether an operation is a data
                      action or not.
                    "name": "str"  # Optional. The name of the operation being performed on this
                      particular object. This name should match the action name that appears in RBAC /
                      the event service.
                }
        """
        _headers = kwargs.pop("headers", {}) or {}
                    ...
                    "properties": {
                        ...
                        "storageProperties": {
                            ...
                            "storageBillingProperties": {
                                ...
                                "sku": "str"  # Optional. the SKU type that is
                                  provisioned.
                            },
