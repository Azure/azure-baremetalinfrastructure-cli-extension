...
class AzureBareMetalInstancesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.baremetalinstances.aio.BareMetalInfrastructureClient`'s
    ...
    async def _shutdown_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, azure_bare_metal_instance_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_shutdown(
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._shutdown_initial(  # type: ignore
                resource_group_name=resource_group_name,
                azure_bare_metal_instance_name=azure_bare_metal_instance_name,
                cls=lambda x, y, z: x,
                headers=_headers,
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, azure_bare_metal_instance_name: str, **kwargs: Any) -> JSON:
...
class AzureBareMetalStorageInstancesOperations:
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, azure_bare_metal_storage_instance_name: str, **kwargs: Any) -> JSON:
